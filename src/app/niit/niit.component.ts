...
export class NiitComponent implements OnInit {
  public zip :string;
  ...
  public news3: string;
    ...
    getStockDetail()
    {
      fetch("https://apidojo-yahoo-finance-v1.p.rapidapi.com/stock/get-detail?region=IN&lang=en&symbol=NIITLTD.NS", {
	"method": "GET",
	"headers": {
  ...
  .catch(err => {
    ...
    getNews()
    {
      fetch("https://apidojo-yahoo-finance-v1.p.rapidapi.com/stock/get-news?region=IN&category=NIITLTD.NS", {
        "method": "GET",
        "headers": {
          "x-rapidapi-host": "apidojo-yahoo-finance-v1.p.rapidapi.com",
          "x-rapidapi-key": "25691efbbbmsh3892ce9c0a7bd85p1058b2jsn0d9d4e8f9157"
